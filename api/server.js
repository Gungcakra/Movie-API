...
app.get('/api/movie-list', async (req, res) => {
  try {
    const { data } = await axios.get('https://mptncaptive.com/');
...
app.get('/api/movie-new', async (req, res) => {
    try {
      const url = 'https://mptncaptive.com/?s=&search=advanced&post_type=&index=&orderby=&genre=&movieyear=2024&country=&quality=';
...
app.get('/api/movie-horror', async (req, res) => {
    try {
      const url = 'https://mptncaptive.com/horror/';
      const { data } = await axios.get(url);
      const $ = load(data);
...
app.get('/api/movie-drama', async (req, res) => {
    try {
      const url = 'https://mptncaptive.com/drama/';
      const { data } = await axios.get(url);
      const $ = load(data);
...
app.get('/api/movie-details/:movieId', async (req, res) => {
    ...
    const url = `https://mptncaptive.com/${movieId}`;
...
app.get('/api/movie-search/:searchId', async (req, res) => {
  ...
  const url = `https://mptncaptive.com/?s=${searchId}&post_type[]=post&post_type[]=tv`;
...
app.get('/api/movie-indo', async (req, res) => {
  const url = `https://mptncaptive.com/?s=&search=advanced&post_type=movie&index=&orderby=&genre=&movieyear=&country=indonesia&quality=`;
...
app.get('/api/movie-genre/:genreId', async (req, res) => {  
  ...
  try {
    const url = `https://mptncaptive.com/${genreId}/`;
    const { data } = await axios.get(url);
    const $ = load(data);
